...
export default function App() {
  ...
  if (view === 'welcome') {
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4 font-sans text-gray-900">
        {/* OPTIMIZATION: max-w-3xl for Laptop/Desktop */}
        <div className="bg-white p-8 rounded-2xl shadow-xl max-w-3xl w-full text-center border border-blue-100 relative">
          ...
          {/* UPDATED TEST TITLE STYLING */}
          <p className="text-sm md:text-lg font-extrabold mb-8 uppercase tracking-wide text-blue-700">
            {testTitle}
          </p>
          ...
          <div className="mt-8 pt-6 border-t border-gray-100 flex flex-col items-center gap-2">
            <p className="text-[10px] md:text-xs font-bold tracking-widest text-gray-400 uppercase text-center">
  ...
  if (view === 'result') {
    ...
    // --- DETERMINE TIER AND STYLING (NEW LOGIC) ---
    ...
    // UPDATED: Timestamp Formatting (DD-MM-YYYY • HH:MM:SS)
    ...
    const timeStr = dateObj.toLocaleTimeString([], { hour12: false }); // 24hr format or standard locale
    ...
    return (
      <div className="min-h-screen bg-gray-50 font-sans text-gray-900 relative">
        ...
        {/* HEADER */}
        <div className="sticky top-0 z-50 bg-white/90 backdrop-blur-md shadow-sm border-b border-gray-100 px-4 py-3 flex items-center justify-between">
           ...
           <div className="flex-1 text-center min-w-0 max-w-2xl mx-auto px-1">
               ...
               {/* UPDATED: Test Title size matched to App Name */}
        ...
        {/* OPTIMIZATION: max-w-5xl for Result Screen */}
        <div className="max-w-5xl mx-auto p-4 space-y-6 pb-24"> 
          ...
          <div className="bg-white p-8 rounded-2xl shadow-xl text-center relative overflow-hidden">
            ...
            {/* UPDATED: Dynamic Status Badge & Message */}
          ...
          {/* 2. ANALYTICS GRID (NEW 6-METRIC LAYOUT) */}
